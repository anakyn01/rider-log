...
<div className="w-1144 h-24 d-flex justify-content-between mb-4">
    <div className="w-758 h-56 d-flex">
        <div className="w-564">
        <input type="text" className="form-control h-56 mag" placeholder="차량번호, 운전자명, 차대번호로 검색해보세요"/>
        </div>        
        <div className="w-178 h-56">
            <a className="btn w-178 h-56 mx-2 text-success border-success d-flex justify-content-center align-items-center" href="http://localhost:3000/06_dash/04_car/1">검색 초기화</a>
        </div>
    </div>
...
<div className="w-1144 h-24 d-flex justify-content-between mb-4">
    <div className="w-372 h-46 d-flex justify-content-between">
        <button className="btn text-success border-success w-178 h-46" data-bs-toggle="modal" data-bs-target="#carModal1">
        선택 차량 소속변경
        </button>
        <button className="btn text-success border-success w-178 h-46 mx-2" data-bs-toggle="modal" data-bs-target="#carModal2">
        선택 차량 삭제
        </button>
    </div>
...
<table className="table table-custom-40 w-1144">
    ...
    <tbody>
        ...
        <tr>
            <td>
            <div className="form-check justify-content-center align-items-centers">
                <input className="form-check-input" type="checkbox" name="remember"/>
            </div>
            </td>
