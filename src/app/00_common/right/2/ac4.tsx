...
import AccToast from "../../toast/2/AccToast";
...
<div className="bg-light rounded-3 p-3">
    <div className="d-flex justify-content-between my-3 h-48 w-1472 align-items-center">
            ...
            <div className="d-flex w-346">
                ...
                <div className="d-flex w-203 h-24 ml-4">
                    <div className="form-check d-flex align-items-center">
                    <input type="radio" className="form-check-input" id="radio1" name="optradio" value="option1" checked/>조치중
                    <label className="form-check-label" htmlFor="radio1"></label>
                    </div>
                    <div className="form-check d-flex align-items-center ml-2">
                    <input type="radio" className="form-check-input" id="radio2" name="optradio" value="option2"/>조치완료
