...
<div className="w-560 mb-5">
      ...
      <div className="valid-feedback">Valid.</div>
      <div className="invalid-feedback fs-14 fw-400 ColorDb121a">새로운 비밀번호를 입력해주세요.</div>
</div>
<div className="w-560 mb-5">
      ...
      <div className="valid-feedback">Valid.</div>
      <div className="invalid-feedback fs-14 fw-400 ColorDb121a">새로운 비밀번호가 일치하지 않습니다..</div>
</div>
<div className="w-560 mb-5">
<a className="w-560 h-56 btn btn-light mainBtn-gray" href="http://localhost:3000/06_dash/08_board/10">비밀번호 변경하기</a>
