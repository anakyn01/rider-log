...
<h6 className="fs-18 fw-700 my-4">조직추가<small><span className="fs-12 ColorDb121a ml-3">*</span>필수입력 항목</small><br/><span className="fs-14 fw-400 Color77787b">접속 하위조직을 추가 할수 있습니다</span></h6>
...
<tr>
    ...
    <td>
       ...
       <div>별따러 가자</div>
        <button className="btn fsGreenSmall border-success text-success">
            소속조직변경
        </button>
       </div>
...
<tr>
    ...
    <td colSpan={3} className="p-2">
        ...
        <input type="text" className="form-control w-254" placeholder="우편번호"/><button className="btn  mx-2 fsGreenSmall border-success text-success">소속조직변경</button>
        </div>       
        ...
        <tr>
            ...
            <td>
                <div className="d-flex justify-content-between w-378">
                    <p>-</p>
                    <a className="btn fsGreenSmall border-success text-success" href="http://localhost:3000/06_dash/03_orgar/3">담당자 지정</a>
                </div>
...
<div className="w-1512 d-flex justify-content-between align-items-center my-4">
<h6 className="fs-18 fw-700">사고조치 담당자</h6>
<button className="btn  fsGreenSmall border-success text-success">사고조치 담당자 추가</button>
</div>
