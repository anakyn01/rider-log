...
<tr>
    ...
    <td>
       ...
       <div>별따러 가자</div>
        <button className="btn w100 h-42 text-success border-success">
            소속조직변경
        </button>
       </div>
...
<tr>
    ...
    <td colSpan={3} className="p-2">
        ...
        <input type="text" className="form-control w-254" placeholder="우편번호"/><button className="btn  mx-2 text-success border-success">소속조직변경</button>
        </div>       
        ...
        <tr>
            ...
            <td>
                ...
                <div className="d-flex justify-content-between w-378">
                    ...
                    <a className="btn w100 h42 text-success border-success" href="http://localhost:3000/06_dash/03_orgar/4">삭제</a>
...
<button className="btn w378 h42 text-success border-success">사고조치 담당자 추가</button>
</div>
