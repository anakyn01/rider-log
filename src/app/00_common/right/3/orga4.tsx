...
<div className="w-1512 p-3">
    ...
    <div className="ml-450"><OrgarToast1/></div>
    </div>
...
<tr>
    ...
    <td>
       ...
       <div>별따러 가자</div>
        <button className="btn btn-outline-success btn-outline-success-w100-h42">
            소속조직변경
        </button>
       </div>
...
<tr>
    ...
    <td colSpan={3} className="p-2">
        ...
        <input type="text" className="form-control w-254" placeholder="우편번호"/><button className="btn btn-outline-success mx-2 btn-outline-success-w100-h42">소속조직변경</button>
        </div>       
        ...
        <tr>
            ...
            <td>
                ...
                <div className="d-flex justify-content-between w-378">
                    ...
                    <a className="btn btn-outline-success btn-outline-success-w100-h42" href="http://localhost:3000/06_dash/03_orgar/4">삭제</a>
...
<button className="btn btn-outline-success btn-outline-success-w378-h42">사고조치 담당자 추가</button>
</div>
