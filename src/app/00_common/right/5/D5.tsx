...
import Complete from "../../toast/5/Complete";
    ...
    <div className="w-1512">
        ...
        <Complete/>    
                    ...
                    <tr>
                        ...
                        <td className="">
                            <div className="d-flex justify-content-between my-1">
                                ...
                                <button className="btn w-84 h-42 text-success border-success">주소 검색</button>
                            </div>
            ...
            <div className="d-flex justify-content-between align-items-center">
                <div className="">
                    <h6 className="fs-18 fw-700 my-4">차량 배정<br/><span className="fs-12 fw-400 Color77787b">조직에 소속된 차량만 배정할 수 있습니다</span></h6>
            ...
            <div className="d-flex justify-content-end my-5">
                <a className="btn btn-success mainBtn-w378-h56" href="http://localhost:3000/06_dash/05_driver/3">
                    운전자 추가 완료
                </a>
            </div>
            </div>
