...
import EditComplete from "../../toast/5/EditComplete";
...
<EditComplete/>
            ...
            <div className="d-flex justify-content-between w-370 h-42">
                <a href="" className="btn border-success text-success w-179 h-42" data-bs-toggle="modal" data-bs-target="#driverdelete">운전자 삭제</a>
                <a href="http://localhost:3000/06_dash/05_driver/6" className="btn bg-success border-success w-179 h-42 text-white">운전자 정보수정</a>
            </div>
