...
<div className="d-flex justify-content-center w-1656">
    ...
    <div className="w-1512">
            <h6 className="fs-18 fw-700 d-flex align-items-center mb-4 mt-2">운전자 정보수정<span className="fs-12 Color77787b ml-3"><span className="fs-12 ColorDb121a">※</span> 필수 입력 항목</span></h6>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div className="d-flex justify-content-between my-1">
                                <input type="text" name="" id="" className="form-control w-270 h-42" placeholder="우편번호"/>
                                <button className="btn border-success text-success w-84 h-42">주소 검색</button>
                            </div>
                    ...
                    <th>보호자 연락처</th>
                    <td>
                        <input type="text" name="" id="" className="form-control" placeholder="숫자만 최대 11자 입력 가능"/>
                    </td>
                    <th>보호자와의 관계</th>
                    <td>
                        <input type="text" name="" id="" className="form-control" placeholder="숫자만 최대 20자 입력 가능"/>
                    </td>
                    </tr>
                    <tr>
                        <th>건강특이사항</th>
            ...
            <table className="table table-custom-40-left">
                ...
                <tbody>
                <tr>
                        <th>보험종류<span className="fs-12 ColorDb121a ml-2">※</span></th>
                        <td>
                        <select name="" id="" className="form-select w-362 h-42">
                            <option value="책임보험">책임보험</option>
                        </select>
                        </td>
                        <th>보험사<span className="fs-12 ColorDb121a ml-2">※</span></th>
                        <td>
                        <select name="" id="" className="form-select w-362 h-42">
                    ...
                    <tr>
                        <th>보험가입일<span className="fs-12 ColorDb121a ml-2">※</span></th>
                        <td>
                       <input type="date" className="form-control w-362 h-42" />
                        </td>
                        <th>보험만기일<span className="fs-12 ColorDb121a ml-2">※</span></th>
                        <td>
                        <input type="date" className="form-control w-362 h-42" />
                        </td>
                    </tr>
                    <tr>
                        <th>보험 상품명<span className="fs-12 ColorDb121a ml-2">※</span></th>
                        <td colSpan={3}>
                        <input type="text" className="form-control h-42"/>  
                        </td>
                    </tr>                    
                </tbody>
            </table>
           
            <div className="mt-40 mb-20 d-flex justify-content-between">
                ...
                <button className="btn btn-outline-success btn-outline-success-w378-h42">
                    차량배정취소
                </button>
...
<col style={{width:"378px"}}/>
    ...
    <tbody>
<tr>
<th>차량번호</th><td>서울가1234</td><th>차대번호</th><td>KMHDL41BP8A000001</td>
</tr>
<tr>
<th>모델명</th><td>오토바이</td><th>연식</th><td>2024</td>
</tr>
<tr>
<th>배기량</th><td>125cc</td><th>차량 소유 구분</th><td>개인</td>
</tr>
<tr>
<th>센서유형</th><td>LTE</td><th>센서번호</th><td>0000000</td>
</tr>
    </tbody>
</table>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M17 9.5C17.6904 9.5 18.25 10.0596 18.25 10.75V23.25C18.25 23.9404 17.6904 24.5 17 24.5C16.3096 24.5 15.75 23.9404 15.75 23.25V10.75C15.75 10.0596 16.3096 9.5 17 9.5Z" fill="#5D5E60"/>
            ...
            <div className="d-flex justify-content-end my-5">
                <a className="btn btn-success mainBtn-w378-h56" href="http://localhost:3000/06_dash/05_driver/7">
                    운전자 추가 완료
                </a>
            </div>
            </div>
