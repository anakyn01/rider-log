 ...
 <div className="w560h4"></div>
      <div className="d-flex justify-content-between align-items-center z99">
        ...
        <div className="w-84 justify-content-center z99">
          <div className="numberLineBorder rounded-circle w-40 h-40 d-flex justify-content-center align-items-center ml-2 fs-20 fw-700">
           2
          </div>
      ...
      담당자님(user@domain.com)의 이름을 입력해주세요.
        </span>
      </div>
  <form action="" className="was-validated">
<div className="w-560">
<p className="fs-18 fw-500">이름</p>
<input type="text" className="form-control input-bg w-560 h-56 rounded-3" placeholder="최대 10자 입력 가능" required/>
...
<a className="btn btn-light w-270 h-56 rounded-3" href="http://localhost:3000/05_signup/2">다음 단계</a>
</div>
