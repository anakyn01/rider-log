...
<div className="mt-20">
    ...
    <div className="fs-12">인증코드</div>
    <div className="fs-12 text-danger">05:00</div>
    </div>

<input type="text" className="form-control h-42" placeholder="6자리 인증코드를 입력해주세요"/>
</div>


<div className="phone-btn-group">

<a className="phone-right-btn mt-10" href="http://localhost:3000/05_signup/3" data-bs-toggle="modal" data-bs-target="#password">이전 단계</a> 
    
<a className="phone-left-btn" href="http://localhost:3000/05_signup/4">다음 단계</a>
...
<div className="sign-bottom-text-re">
인증코드 재전송 (0/5)    
</div>
</div>
</>
