...
<div className="mobile-content">
      ...
      <div className="mt-50 d-flex justify-content-between align-items-center mb-30">
        ...
        <div className="">
            <p className="fs-16 fw-700">조직 관리</p>
            <p>별따러가자</p>
        </div>
      ...
      <div className="mt-10">
        <input type="text" className="form-control h-50 rounded-3 input-bg mag" placeholder="조직명, 담당자명으로 검색해보세요"/>
      </div>
...
<div className="h-72 border rounded-3 p-3 d-flex justify-content-between align-items-center mt-10">
    <div className="fs-14 fw-700">별따러가자 <br/><span className="fs-14 fw-400 Color77787b">사업계약자</span></div>
    <div className="fs-14 fw-400">김별따 <br/><span className="fs-14 fw-400 Color77787b">01012345678</span></div>
    <div className="">
