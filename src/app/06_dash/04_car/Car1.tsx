...
<div className="h-72 border rounded-3 p-3 d-flex justify-content-between align-items-center mt-10">
    <div className="fs-14 fw-700">서울가1234 <br/><span className="fs-14 fw-400 Color77787b">김별따</span></div>
    <div className="fs-14 fw-400">LTE<br/><span className="fs-14 fw-400 Color77787b">000000000000000</span></div>
    <div className="">
