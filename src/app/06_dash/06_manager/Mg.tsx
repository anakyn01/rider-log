...
<div className="d-flex w-100 justify-content-between align-items-center mt-10 mb-10">
    <div className="fs-12 Color77787b">총 21건<br/>도움말
    <span>
...
<div className="h-72 border rounded-3 p-3 d-flex justify-content-between align-items-center mt-10">
    <div className="fs-14 fw-700">김별따<br/><span className="fs-14 fw-400 Color77787b">강남구점<br/>조직 담당자</span></div>
    <div className="fs-14 fw-400">01012345678<br/><span className="fs-14 fw-400 Color77787b">user@domain.com</span></div>
    <div className="">
